package com.gestankbratwurst.eprocore.util.tasks;
...
public class TaskManager {
  ...
  public static TaskManager getInstance() {
    return TaskManager.instance == null ? new TaskManager(JavaPlugin.getPlugin(EproCore.class)) : TaskManager.instance;
  }
  ...
  public TaskManager(final EproCore plugin) {
    // TODO FIXME
    final int threadPoolSize = 4;// plugin.getPssIO().loadConfiguration().getSchedulerThreadPoolSize();
